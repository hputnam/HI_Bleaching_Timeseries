...
mcap.a.all <- lmer(log10(alpha) ~ Bleach * Date + (1|Pair), data = mcapa)
...
pcom.a.all <- lmer(log10(alpha) ~ Bleach * Date + (1|Pair), data = pcoma)
...
# PCOM
pcompro$proafdw <- pcompro$proaFrag.ug/pcompro$AFDW.g
